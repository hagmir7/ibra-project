        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="footer-box about-widget">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum veritatis itaque, ipsum quasi ab cumque libero nemo pariatur quos quas quibusdam inventore blanditiis, non vel, fuga illo ipsam id! Quidem.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
